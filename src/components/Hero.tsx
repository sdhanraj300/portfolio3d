...
export default function Hero() {
  ...
  const handleAnimationComplete = () => {
    ...
    // You can add any additional logic here that should run after the animation completes
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
        <div className="text-center">
          <SplitText
            ...
            className="text-lg md:text-xl text-blue-400 font-mono mb-4 block"
            delay={100}
            duration={0.5}
            ease="power2.out"
            splitType="words"
          ...
          <div className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6">
            <BlurText
              text="Dhanraj Singh"
              delay={100}
              animateBy="letters"
              ...
              className="text-8xl mb-8 inline-block bg-clip-text"
            />
          </div>
          ...
          >
            I&apos;m a passionate <span className="text-white font-medium">Full-Stack Developer</span> specializing in building exceptional digital experiences. Currently, I&apos;m focused on creating accessible, human-centered products at{' '}
